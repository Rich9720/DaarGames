$(document).ready(function () {
    ...
    function llenaCarrito(response){
        ...
        response.forEach(element => {
            $("#listaCarrito").append(
                `
                <a href="catalogoindex.php?modulo=detalleproducto&id=${element['id']}" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
        ...
        $("#listaCarrito").append(
            `
            <a href="catalogoindex.php?modulo=carrito" class="dropdown-item dropdown-footer text-primary">
            Ver carrito 
